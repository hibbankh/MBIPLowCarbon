...
<head>
    ...
    <style>
       ...
       footer {
        ...
        form {
    background-color: #4caf50; /* Green background color associated with recycling */
    padding: 20px;
    border-radius: 10px;
    box-shadow: 0 0 20px rgba(0, 0, 0, 0.1);
    height: 570px;
    position: relative; /* Added position relative for absolute positioning of icon */
}
...
form:before {
    ...
    font-size: 60px;
    color: #fff; /* White color for the recycling symbol */
    position: absolute;
    top: 50%;
    left: 50%;
...
/* Style adjustments for text and elements within the form */
form h1,
form h4,
form p {
    color: #fff; /* White text color for better contrast on the green background */
}
...
<body>
    ...
    <%User user=(User)request.getAttribute("user"); %>
        ...
        <form action="addRecycle" method="post">
        <h4>Hello <%=user.getFullName() %></h4>
            ...
            <label for="amount"><h2>Enter your Recycle Consumption(Kg):</h2></label>
