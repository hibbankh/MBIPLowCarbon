...
<%Admin admin=(Admin)request.getAttribute("admin"); %>
    ...
    <main>
        ...
        <h4>Admin: <%=admin.getFullName() %></h4>
        <a href="<%= request.getContextPath() %>/deleteUser" class="upload-button electricity-button">Delete User</a>
      
        <div class="upload-buttons-container">
            <a href="<%= request.getContextPath() %>/viewReport" class="upload-button water-button">Show Report</a>
            
            <a href="<%= request.getContextPath() %>/viewReportUser" class="upload-button recycle-button">Show User Report</a>
        </div>
